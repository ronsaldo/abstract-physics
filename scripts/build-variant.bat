...
msbuild APHY.sln /p:Configuration=Debug /p:Platform=%VS_PLATFORM%
msbuild APHY.sln /p:Configuration=RelWithDebInfo /p:Platform=%VS_PLATFORM%
msbuild APHY.sln /p:Configuration=Release /p:Platform=%VS_PLATFORM%
